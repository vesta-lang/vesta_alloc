...
void vesta_host_stats(VestaHostAllocStats *out) {
     ...
     * nombran EL MISMO tipo -- se declara en la cabecera de C --, asi que no
     * hay nada que traducir.  Copiar campo a campo seria ademas el sitio donde
     * las dos versiones podrian dejar de coincidir sin que nada lo dijera. */
    *out = util::host_alloc_stats();
}
